<div id="them" class="w3-modal">
	<div class="w3-modal-content w3-animate-top" style="max-width: 500px">
		<div class="w3-container w3-light-grey" style="padding-bottom: 16px">
			...
			<form class="w3-container w3-light-blue w3-round-large" role="form" enctype="multipart/form-data" action="/admin/douong" method="POST">{{ csrf_field() }}
				<div class="w3-section">
					...
					<div class="form-group col-sm-12 col-md-12 col-xs-12 w3-margin-bottom">
						...
						<div class="col-sm-9">
							<input class="w3-input w3-border w3-round-large" type="text" placeholder="Mô tả" name="mota" required>
						</div>
					</div>
					<div class="form-group col-sm-12 col-md-12 col-xs-12 w3-margin-bottom">
					...
					<div class="form-group col-sm-12 col-md-12 col-xs-12 w3-margin-bottom">
						...
						<div class="col-sm-9">
							<input class="w3-input w3-border w3-round-large" id="gia" type="number" size="6" maxlength="6" placeholder="Giá tiền (vnđ)" name="giatien" required>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
						<span class="w3-btn-block w3-red w3-section w3-padding w3-round-large" onclick="document.getElementById('them').style.display='none'">Hủy</span>
					</div>
				</div>
			</form>
		</div>
